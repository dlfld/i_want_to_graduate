...
class AttentionModule(torch.nn.Module):
    ...
    def setup_weights(self):
        ...
        Defining weights.
        """
        self.weight_matrix = torch.nn.Parameter(torch.Tensor(100,
                                                             1).cuda())
    ...
    def forward(self, embedding):
        ...
        # import logddd
        # logddd.log(sigmoid_scores.shape)
        representation = torch.mm(sigmoid_scores,embedding)
        # exit(0)
...
# ======================================================attention =============================================================================
    ...
    def forward(self, data,mode='train'):
        ...
        # import logddd
        # logddd.log(hg1.shape)
# ======================================================添加attention ================================================================================

        hg1 = self.attention(hg1)
        hg2 = self.attention(hg2)
# ======================================================添加attention ================================================================================
