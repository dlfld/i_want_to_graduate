...
def split_data(data):
    """
        划分数据，换分训练集测试集和验证集
    """
    X_train, X_validate_test, _, _ = train_test_split(data, data, test_size = 0.2, random_state = 42)
    X_validate, X_test, _, _ = train_test_split(X_validate_test, X_validate_test, test_size = 0.5, random_state = 42)
