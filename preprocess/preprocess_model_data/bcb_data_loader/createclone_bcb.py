...
def creategmndata(id, treedict, vocablen, vocabdict):
    ...
    testdata = []
    print('train data')
    traindata = createpairdata(treedict, trainlist)
    print('valid data')
    validdata = createpairdata(treedict, validlist)
    print('test data')
    testdata = createpairdata(treedict, testlist)
    return traindata, validdata, testdata


def createpairdata(treedict, pathlist):
    datalist = []
    countlines = 1
